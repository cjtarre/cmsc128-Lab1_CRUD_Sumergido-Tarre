                    ...
                    <div className="absolute right-0 z-50 mt-2 w-60 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg">
                        ...
                        <div className="border-t border-slate-100 p-1.5">
                            <button
                                ...
                                className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm text-red-500 transition hover:bg-red-50 hover:text-red-500"
                            >
                                <LogOut size={16} />
                                Logout
                            </button>
